        ...
        <div class="form-horizontal" style="">
            ...
            <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" disabled class="form-control" name="txt_carrera" value="<?php echo 1; ?>">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" disabled class="form-control" name="txt_universidad" value="<?php  echo 1; ?>">
                    </div>
